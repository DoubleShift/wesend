...
import 'package:wesend_app/model/state/send/sending_file.dart';
...
import 'package:wesend_app/rust/api/http.dart' as rust_http;
import 'package:wesend_app/rust/api/model.dart' as rust_model;
  ...
  Future<void> startSession({
    ...
    if (fileMap.isEmpty) {
      ...
      if (state[sessionId]?.background == false) {
        // ignore: use_build_context_synchronously, unawaited_futures
        Routerino.context.pushRootImmediately(() => const HomePage(initialTab: HomeTab.contacts, appStart: false));
      }
