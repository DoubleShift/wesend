...
import 'package:wesend_app/util/file_speed_helper.dart';
...
import 'package:wesend_app/widget/custom_progress_bar.dart';
import 'package:wesend_app/widget/dialogs/cancel_session_dialog.dart';
...
class _ProgressPageState extends State<ProgressPage> with Refena {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      canPop: false,
      child: Scaffold(
        appBar: widget.showAppBar ? basicWeSendAppbar(title) : null,
        body: Stack(
          children: [
            ListView.builder(
