...
import 'package:wesend_app/widget/animations/initial_fade_transition.dart';
import 'package:wesend_app/widget/animations/initial_slide_transition.dart';
import 'package:wesend_app/widget/custom_basic_appbar.dart';
import 'package:wesend_app/widget/dialogs/error_dialog.dart';
...
class _SendPageState extends State<SendPage> with Refena {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      canPop: true,
      child: Scaffold(
        appBar: widget.showAppBar ? basicWeSendAppbar('') : null,
        body: SafeArea(
          child: Center(
