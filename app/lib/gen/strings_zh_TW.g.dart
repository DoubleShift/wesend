...
class _TranslationsApkPickerPageZhTw extends TranslationsApkPickerPageEn {
  ...
  @override
  String get excludeAppsWithoutLaunchIntent => '排除不可啟動的應用程�?;
  @override
...
class _TranslationsReceiveOptionsPageZhTw extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(LocalSend 資料�?';
  @override
...
class _TranslationsAboutPageZhTw extends TranslationsAboutPageEn {
  ...
  List<String> get description => [
    ...
    '此應用程式可�?Android、iOS、macOS、Windows �?Linux 上使用�?您可以在官網首頁上找到所有下載選項�?,
  ];
  @override
  String get author => '作�?;
  @override
...
class _TranslationsAssetPickerZhTw extends TranslationsAssetPickerEn {
  ...
  @override
  String get unableToAccessAll => '無法存取此裝置上的所有檔�?;
  @override
  ...
  @override
  String get accessLimitedAssets => '以受限制的存取繼�?;
  @override
...
class _TranslationsSettingsTabGeneralZhTw extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get saveWindowPlacementWindows => '離開時儲存視窗位�?;
  @override
  String get minimizeToTray => '關閉時最小化至系統匣';
  @override
  String get launchAtStartup => '登入後自動啟�?;
  @override
...
class _TranslationsSettingsTabReceiveZhTw extends TranslationsSettingsTabReceiveEn {
  ...
  @override
  String get autoFinish => '自動完成傳送任�?;
  @override
  String get destination => '儲存目錄';
  @override
  String get downloads => '(下載)';
  @override
  String get saveToGallery => '儲存媒體至相�?;
  @override
  String get saveToHistory => '儲存至歷史記�?;
}
...
class _TranslationsSettingsTabSendZhTw extends TranslationsSettingsTabSendEn {
  ...
  String get title => '傳�?;
  @override
  String get shareViaLinkAutoAccept => '透過連結分享：自動同意接收要�?;
}
...
class _TranslationsTroubleshootPageFirewallZhTw extends TranslationsTroubleshootPageFirewallEn {
  ...
  @override
  String solution({required Object port}) => '這很可能是防火牆問題。您可以透過允許通訊�?${port} 上的連入連線 (UDP �?TCP) 以解決此問題�?;
  @override
  String get openFirewall => '開啟防火�?;
}
...
class _TranslationsTroubleshootPageNoDiscoveryZhTw extends TranslationsTroubleshootPageNoDiscoveryEn {
  ...
  @override
  String get solution => '請確保所有裝置都在同一�?Wi‑Fi 網路上並共用相同的設�?(通訊埠、多點傳送位址、加密選�?。您可以嘗試手動輸入目標裝置�?IP 位址。如果這樣可以運作，考慮將此裝置新增至最愛，以便未來可以自動偵測到�?;
}
...
class _TranslationsTroubleshootPageNoConnectionZhTw extends TranslationsTroubleshootPageNoConnectionEn {
  ...
  @override
  String get solution => '雙方都存在問題？然後你需要確保兩部裝置處於相同的 Wi‑Fi 網路中並共用相同的組�?(通訊埠、多點傳送位址、加密選�?。Wi‑Fi 可能不允許參與者之間進行通訊。在這種狀況下，必須在路由器上停用「存取點 (AP) 隔離」選項�?;
}
...
class _TranslationsReceiveHistoryPageEntryActionsZhTw extends TranslationsReceiveHistoryPageEntryActionsEn {
  ...
  @override
  String get showInFolder => '在資料夾中顯�?;
  @override
  String get info => '資訊';
  @override
  String get deleteFromHistory => '從歷史記錄刪�?;
}
...
class _TranslationsDialogsEncryptionDisabledNoticeZhTw extends TranslationsDialogsEncryptionDisabledNoticeEn {
  ...
  @override
  String get content => '目前的通訊透過未經加密�?HTTP 通訊協定執行。若要使�?HTTPS，請再次啟用加密�?;
}
...
class _TranslationsDialogsQuickActionsZhTw extends TranslationsDialogsQuickActionsEn {
  ...
  @override
  String get prefix => '前置�?;
  @override
  String get padZero => '字元零填�?;
  @override
  String get sortBeforeCount => '事先依字母排�?;
  @override
...
class _TranslationsProgressPageTotalTitleZhTw extends TranslationsProgressPageTotalTitleEn {
  ...
  @override
  String get finishedError => '已完成，但發生錯�?;
  @override
